...
Collisions::Collisions() : Module()
{
	...
	matrix[Collider::Type::PLAYER][Collider::Type::NEAR] = true;

	matrix[Collider::Type::NEAR][Collider::Type::WALL] = true;
	matrix[Collider::Type::NEAR][Collider::Type::PLAYER] = true;
	matrix[Collider::Type::NEAR][Collider::Type::ENEMY] = true;
